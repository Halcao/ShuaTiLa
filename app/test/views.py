...
def test_page(id):
     ...
     for question in questions:
       ...
       question1=[str(question1[0]),question1[1],question1[2]+';'+question1[3]+';'+question1[4]+';'+question1[5],question1[6]]
     ...
     cur.close()
     db.close()
     session['question_dict'] = question_dict
     session['judge_dict'] = judge_dict
     session['fill_dict'] = fill_dict
     session['all_dict'] = all_dict




     return render_template('test.html', question_dict=json.dumps(question_dict),
                            judge_dict=json.dumps(judge_dict), fill_dict=json.dumps(fill_dict),all_dict=json.dumps(all_dict))